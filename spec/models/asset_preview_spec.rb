...
describe AssetPreview, :vcr do
  describe "Attachment" do
    it "scales down a big image and keeps original" do
      ...
      expect(asset_preview.file.url).to match("#{AWS_S3_ENDPOINT}/gumroad-specs/#{asset_preview.file.key}")
      expect(asset_preview.retina_variant.url).to match("#{AWS_S3_ENDPOINT}/gumroad-specs/#{asset_preview.retina_variant.key}")
    ...
    it "succeeds with video" do
      ...
      expect(asset_preview.url).to match("#{AWS_S3_ENDPOINT}/gumroad-specs/#{asset_preview.file.key}")
    end
